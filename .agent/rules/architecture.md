...
- **SEMPRE** use `z.nativeEnum(WeekDay)` importado de `../generated/prisma/enums.js` para tipar campos de dia da semana nos schemas. **NUNCA** use `z.string()` ou `z.enum()` para representar WeekDay.
